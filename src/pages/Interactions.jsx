  ...
  const interactions = [
    {
      ...
      message:
        "Pengingat Otomatis: Stok obat rutin Anda diperkirakan habis dalam 3 hari. Balas 'YA' untuk proses refill resep.",
      time: "Hari ini, 09:00",
      status: "Terkirim",
    ...
    },
    {
      ...
      message:
        "Newsletter: Promo Bundling Vitamin C khusus pelanggan setia PharmaCare.",
      time: "Kemarin, 14:30",
      status: "Dibaca",
      badgeVariant: "info",
    },
    {
      ...
      message:
        "Pasien konsultasi mengenai dosis vitamin anak. Apoteker menyarankan dosis 1 sendok teh sehari setelah makan.",
    ...
    },
    {
      ...
      message:
        "Follow up pasca-pembelian antibiotik. Pasien dihubungi untuk dipastikan menghabiskan obat sesuai resep dokter.",
    ...
    <div className="p-6 font-poppins">
      <PageHeader
        ...
        actionButton={
          <Button
            ...
            onClick={() =>
              toast.success(
                "Pesan massal berhasil disebarkan ke WhatsApp pasien!",
              )
            }
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6 mb-6">
        <StatCard
          ...
          value="1,245"
          icon={<BsChatDotsFill className="text-[32px] text-slate-500 mb-2" />}
          borderColor="border-slate-300"
          subtext="View Broadcast History"
          bgFooter="bg-slate-100"
        />
        <StatCard
          title="Pesan Dibaca"
          value="89%"
          icon={<BsWhatsapp className="text-[32px] text-[#10b981] mb-2" />}
          borderColor="border-[#10b981]"
          subtext="View Read Analytics"
          bgFooter="bg-[#d1fae5]"
        />
        <StatCard
          title="Refill Sukses"
